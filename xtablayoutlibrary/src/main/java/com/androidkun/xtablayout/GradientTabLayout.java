...
public class GradientTabLayout extends HorizontalScrollView {
    ...
    public GradientTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GradientTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        super.addView(mTabStrip, 0, new FrameLayout.LayoutParams(
   ...
   /*     TypedArray a = context.obtainStyledAttributes(attrs, android.support.design.R.styleable.TabLayout,
        ...
        indicatorColorStart = a.getColor(R.styleable.XTabLayout_xTabIndicatorColorStart, Color.parseColor("#ff4241"));
        indicatorColorEnd = a.getColor(R.styleable.XTabLayout_xTabIndicatorColorEnd, Color.parseColor("#ff6243"));
...
//        invalidate();
    ...
    public static final class Tab {
        ...
        private GradientTabLayout mParent;
...
//                        mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
                Shader mShader = new LinearGradient(mIndicatorLeft, 0, mIndicatorRight, 0,
                        new int[] { indicatorColorStart, indicatorColorEnd }, null, Shader.TileMode.CLAMP);
                mSelectedIndicatorPaint.setShader(mShader);
                RectF mRecf = new RectF(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight,
                        mIndicatorRight, getHeight());
                canvas.drawRoundRect(mRecf, mSelectedIndicatorHeight /2 ,
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<GradientTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(GradientTabLayout tabLayout) {
        ...
        public void onPageScrolled(int position, float positionOffset,
            ...
            final GradientTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
